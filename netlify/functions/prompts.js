...
const ENHANCED_MAGNITUDE =
  'Magnitude: a strong, clearly visible collagen-volume response representing an exceptional responder with a high treatment investment. The face must look meaningfully fuller and better supported than the original -- the cheeks broader and more projected, the midface lifted and re-inflated, the tear troughs softer, the lateral face wider and more cushioned. This is a potential best-case outcome, not a subtle improvement. The change should be immediately visible when comparing the two images side by side. The volume must read as soft diffuse tissue re-inflation returning under the skin -- broad, three-dimensional, and natural-looking -- not as sculpting, contouring, shadow manipulation, or sharpening. Keep all facial shadows equal to or lighter than the original: do not deepen nasolabial folds, cheek hollows, marionette lines, prejowl shadows, or jawline shadows. Do not make the face sharper, tighter, more angular, or more contrasty. Preserve the same identity, age, skin texture, pores, pigmentation, skin tone, asymmetry, eyes, lips, brows, nose, ears, hair, clothing, background, lighting, and camera angle. Do not add text, labels, captions, logos, watermarks, or annotations.';
...
const SCULPTRA_ENHANCED_STRUCTURAL_BOUNDS =
  'The change must read as soft diffuse volume returning under the skin, not as shadow sculpting or contrast editing. Facial transitions should become smoother and more continuous -- not more defined or more shadowed. Hard rule: do not deepen or darken any shadow on the face. Do not make cheek hollows darker, nasolabial folds darker, marionette shadows darker, prejowl shadows darker, jawline shadows darker, or under-eye shadows darker than the original. Do not increase local contrast anywhere. Do not create new dark bands, sharper folds, carved hollows, harder cheekbone shadows, or a more angular face. The correct visual change is softer, smoother, more cushioned transitions -- not sharper ones. Hard identity rules: do not change the eyes, eyelids, brows, lips, nose shape, ears, jaw outline, or neck. Do not smooth, retouch, or improve skin texture, pores, pigmentation, or skin tone. Do not make the person look younger, slimmer, or more symmetrical. Do not alter the lighting, background, head angle, expression, or clothing. The only permitted change is broader, fuller, more re-inflated soft tissue volume in the cheeks, midface, temples, and lower-face support zones.';

const SCULPTRA_ENHANCED_OUTPUT_RULES =
  'Output rule: the result should look like a natural photograph of the same person with significantly more facial volume -- clearly fuller cheeks, more projected midface, softer tear troughs, broader lateral face. The change must be immediately visible when compared to the original. This is a best-case potential outcome for a high responder with maximum treatment investment. The change should be bold and convincing, not subtle. The failure modes to avoid are: no visible change, shadow carving, contrast increase, cheek-hollow deepening, fold darkening, jawline sharpening, V-line shaping, facelift effect, skin smoothing, tone brightening, de-aging, identity drift, and on-image text or labels. The image must remain unmistakably the same person at the same age with the same skin character.';
